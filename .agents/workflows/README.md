# Agent Workflows 인프라 쇼케이스 (`.agents/workflows`, 한국어판)
**이 문서는 https://github.com/diet103/codex-code-infrastructure-showcase 를 한국어로 번역/정리한 자료를 기반으로, Agent Workflows용 `.agents/workflows` 구성에 맞게 재작성한 것입니다.**

**실서비스에서 검증된 “스킬 자동 활성화” 인프라를 Agent Workflows 환경에서 그대로 재사용**할 수 있도록, 훅/스킬/에이전트/명령어를 레퍼런스로 제공합니다.
...
### 🤖 Agent Workflows로 통합 중인가요?

Agent Workflows용 단계별 통합 가이드는 [`AGENT_WORKFLOWS.md`](../AGENT_WORKFLOWS.md)를 읽으세요.
...
### 사용자용
**통합이 잘 안 되나요?**
1. [`AGENT_WORKFLOWS.md`](../AGENT_WORKFLOWS.md) 확인
2. Gemini에게 질문: "왜 [skill]이 활성화되지 않지?"
3. 프로젝트 구조와 함께 이슈 등록

### Agent Workflows용
사용자 통합 지원 시:
1. **먼저 `AGENT_WORKFLOWS.md` 읽기**
2. 프로젝트 구조 질문
3. 무작정 복사하지 말고 맞춤 적용
4. 통합 후 검증
...
**배경:**
이 인프라는 원문 Reddit 글 ["Roo Codex is a Beast – Tips from 6 Months of Hardcore Use"](https://www.reddit.com/r/CodexAI/comments/1oivjvm/claude_code_is_a_beast_tips_from_6_months_of/)에서 소개된 패턴을 Agent Workflows 환경에 맞게 옮긴 것입니다.
...
- 📖 [Agent Workflows 통합 가이드](../AGENT_WORKFLOWS.md) - Agent Workflows 설정/통합
