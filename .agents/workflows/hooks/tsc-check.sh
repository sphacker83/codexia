...
# Uses stderr for visibility in Agent Workflows main interface
...
CACHE_DIR="$PROJECT_DIR/.agents/workflows/tsc-cache/$SESSION_ID"
...
find "$PROJECT_DIR/.agents/workflows/tsc-cache" -maxdepth 1 -type d -mtime +7 -exec rm -rf {} \; 2>/dev/null || true
